...
var tests = new (string Name, Action Body)[]
{
    ...
    ("Twenty-minute provider metrics use medians", TestRollingProviderMetricsUseMedians),
    ("Rolling provider metrics discard samples outside the window", TestRollingProviderMetricsDiscardExpiredSamples),
    ("Rolling provider metrics clear account history", TestRollingProviderMetricsClearHistory),
    ("Rolling provider metrics are stable for duplicate groups", TestRollingProviderMetricsAreStableForDuplicateGroups),
